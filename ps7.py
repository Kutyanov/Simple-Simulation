...
class RectangularRoom(object):
    ...
    def getRandomPosition(self):
        ...
        """
        y = math.floor(random.random())*(self.height - 1)
        x = math.floor(random.random())*(self.width - 1)
        return Position(x, y)
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.position = Position(random.uniform (0, self.room.width), random.uniform(0, self.room.height))
        self.clean = self.room.cleanTileAtPosition(self.position)
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        self.newdir=int(random.random()*360)
        self.newpos=Position.getNewPosition(self.getRobotPosition(),self.getRobotDirection(),self.speed)
        if self.room.isPositionInRoom(self.newpos)==True:
...
#Uncomment these two functions to see plots.
...
showPlot2('Percentage Of Room That A Robot Cleans', 'num_robots', 'num_steps' )
